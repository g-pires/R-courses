...
There exist several themes in ggplot2, black and white, gray, void, minimal, classic, light and so on. But what if we want our own theme, with the colors we want, a grid or not, and a specific font ? We must create our own theme to do that. Here we will use the black and white theme as a base theme and the function \textit{{\color{blue} %+replace%}} which replaces the entire element in a theme and if any element of a theme is not specified in the new theme, it will not be present in the resulting theme.
